...
/// No vendor name may appear outside DoubleProviders. Scans source files, not tests.
final class BoundaryTests: XCTestCase {
    func testNoVendorNamesOutsideProviders() throws {
        ...
        var hits: [String] = []
        for module in ["DoubleApp", "DoubleCore", "DoubleTools", "DoubleWatch"] {
        ...
        XCTAssertEqual(hits, [], "vendor name leaked outside DoubleProviders")
    }
}

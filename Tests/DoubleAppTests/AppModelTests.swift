...
final class AppModelTests: XCTestCase {
    ...
    override func setUp() {
        root = FileManager.default.temporaryDirectory.appending(path: "double-app-\(UUID().uuidString)")
        settings = AppSettings(defaults: UserDefaults(suiteName: "com.double.app.tests.\(UUID().uuidString)")!)
